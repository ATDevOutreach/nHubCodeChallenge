...
<html dir="ltr">
	...
	<head>
		...
		<title>Terminus.ng > Register</title>
		<!-- Custom CSS -->
            ...
            <div class="auth-box">
                <div>
                    <div class="logo">
                        ...
                        <h5 class="font-medium m-b-20">Sign Up to Terminus.ng</h5>
                    </div>
                    <!-- Form -->
                    <div class="row">
                        <div class="col-12">
                            <form class="form-horizontal m-t-20" method="post" action="{{ route('post_register') }}">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group m-b-0 m-t-10 ">
                                    <div class="col-sm-12 text-center ">
                                        Already have an account? <a href="{{ route('get_login') }}" class="text-info m-l-5 "><b>Sign In</b></a>
                                    </div>
                                </div>
                            </form>
                        </div>
